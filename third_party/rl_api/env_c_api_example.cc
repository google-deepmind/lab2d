...
const int kObservationCount = 5;
enum ObservationTypes {
  ObservationTypes_Bytes,
  ObservationTypes_Doubles,
  ObservationTypes_String,
  ObservationTypes_Int32s,
  ObservationTypes_Int64s
};

const char* const kObservationNames[] = {"BYTES", "DOUBLES", "STRING", "INT32S",
                                         "INT64S"};

const int kObservationBytesDim[] = {10, 2};
const int kObservationDoublesDim[] = {7};
const int kObservationStringDim[] = {0};
const int kObservationInt32sDim[] = {4};
const int kObservationInt64sDim[] = {6};
...
const EnvCApi_ObservationSpec kObservationSpecs[] = {
    ...
    {EnvCApi_ObservationInt32s, 1, kObservationInt32sDim},
    {EnvCApi_ObservationInt64s, 1, kObservationInt64sDim}};
...
class MyGame {
 public:
  ...
  int Start(int episode_id, int seed) {
    ...
    for (auto& int32_ref : observation_int32s_) {
      int32_ref = 127;
    }
    for (auto& int64_ref : observation_int64s_) {
      int64_ref = 127;
    }
    return 0;
  }
  ...
  void Observation(int observation_idx, EnvCApi_Observation* observation) {
    ...
    switch (observation_idx) {
      ...
      case ObservationTypes_String:
        ...
        break;
      case ObservationTypes_Int32s:
        observation->payload.int32s = observation_int32s_;
        break;
      case ObservationTypes_Int64s:
        observation->payload.int64s = observation_int64s_;
        break;
    }
  }
 ...
 private:
  ...
  std::int32_t observation_int32s_[4];
  std::int64_t observation_int64s_[6];
  int string_shape_[1];
  std::string string_;
};
